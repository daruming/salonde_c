...
class _MyProfileScreenState extends State<MyProfileScreen>
  ...
  void initState() {
    ...
    // if (_authViewModel.loginScreenViewState.runtimeType != Loaded) {
    ...
    return WillPopScope(
      ...
      child: Obx(() {
        ...
        return Scaffold(
            ...
            body: Obx(() {
              return _authViewModel.userModel.value == null
                  ...
                  : SingleChildScrollView(
                      ...
                      Center(
                        child: GestureDetector(
                          onTap: () {
                            print("클릭");
                            _showPicker(context,
                                pictureOrder: "profileImageUrl");
                          },
                          child: Container(
                            child:
                                (_authViewModel.userModel.value != null &&
                                        _authViewModel.userModel.value
                                                ?.profileImageUrl !=
                                            null &&
                                        _authViewModel.userModel.value
                                                ?.profileImageUrl !=
                      ...
                      Text(_authViewModel.userModel.value?.email ?? ""),
                          ...
                          children: <Widget>[
                            CustomFormButton(
                              ...
                              onPressed: () {
                                ...
                                _authViewModel.userValueCheckInProfile(
                                    _makeTempUserModel());
                                ...
                                if (!_authViewModel.profileDataNullCheck ||
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                        content: Text("저장중입니다. 잠시만 기다려주세요!")),
                                  );
                                } else {
                                  showDialog(
                                    barrierColor: Colors.black26,
                            ...
                            CustomFormButton(
                              ...
                              onPressed: () {
                                _authViewModel.signOut();
                                Get.until((route) =>
                                    Get.currentRoute == LoginScreen.routeName);
                              },
                            ),
                          ],
                        );
